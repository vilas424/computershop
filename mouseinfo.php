														  ...
														  <tr>
															...
															<h3>
																					<?php
																							...
																							$result=mysql_query("SELECT *FROM mouse where mtype='$type' and mcost<='$cost'");
																							?>
                                                                                                                                                                                        <table border="5">
																							<tr border="5"><th>Company</th><th>Model No</th><th>Type</th><th>Cost</th><th>Image</th></tr>
																							<?php
																							While($row=mysql_fetch_assoc($result))
																							{
																							$ii=$row['img_path'];?>
																							<tr><td><?php echo $row['mCompany'];?></td>
																							<td><?php echo $row['mmodel'];?></td>
																							...
																							<tr><td><?php echo "No more results  Found"?></td></tr><?php
																							}
																							?>
																							</table><br><br><br>
