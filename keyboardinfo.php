														  ...
														  <tr>
															...
															<h3>
																					<?php
																							...
																							$result=mysql_query("SELECT *FROM keyboard where cost<='$cost' and Ktype='$type'");
																							?><table border="5">
																							<tr border="5"><th>Company</th><th>Model</th><th>Cost</th><th>Type</th><th>Image</th></tr>
																							<?php
																							While($row=mysql_fetch_assoc($result))
																							{
																							$ii=$row['img_path'];?>
																							<tr><td><?php echo $row['Kcompany'];?></td>
																							<td><?php echo $row['Kmodel'];?></td>
																							<td><?php echo $row['cost'];?></td>
																							<td><?php echo $row['Ktype'];?></td>
