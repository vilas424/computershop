															...
															<h3>
																					<?php
																							...
																							*/
																							...
																							$result=mysql_query("SELECT *FROM hdd where size='$size' and cost<='$cost'");
																							?><table border="5">
																							<tr border="5"><th>Company</th><th>Model No</th><th>capacity</th><th>Cost</th><th>Image</th></tr>
																							<?php
																							While($row=mysql_fetch_assoc($result))
																							{
																							$ii=$row['img_path'];?>
																							<tr><td><?php echo $row['hcompany'];?></td>
