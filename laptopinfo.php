														  ...
														  <tr>
																...
																<td align="left" valign="top">
																					...
																					<?php
																							...
																							$result=mysql_query("SELECT *FROM laptop where Lram='$ram' and Lhdd='$hdd' and Lprocessor='$processor'");
																							?><table border="5">
																							<tr border="5"><th>Company</th><th>Model</th><th>Cost</th><th>Processor</th><th>RAM</th><th>HDD</th><th>Image</th></tr>
																							<?php
																							While($row=mysql_fetch_assoc($result))
																							{
																							$ii=$row['img_path'];?>
																							<tr><td><?php echo $row['Lcompany'];?></td>
																							<td><?php echo $row['Lname'];?></td>
																							<td><?php echo $row['Lcost'];?></td>
																							<td><?php echo $row['Lprocessor'];?></td>
																							<td><?php echo $row['Lram'];?></td>
																							<td><?php echo $row['Lhdd'];?></td>
																							<td><?php echo "<img src='$ii' width='100' height='100'/>";?></td></tr>
																							<?php
																							}
																							if(!$row)
																							{?>
																							<tr><td><?php echo "No more Found"?></td></tr><?php
																							}
																							?>
																							</table><br><br><br>
