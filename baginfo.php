															...
															<h3>
																					<?php
																							...
																							*/
																							...
																							$result=mysql_query("SELECT *FROM bag where btype='$type' and cost<='$cost'");
																							?><table border="3">
																							<tr border="2"><th>Company</th><th>Model No</th><th>Type</th><th>Cost</th><th>Image</th></tr>
																							<?php
																							...
																							{?>
																							<tr><td>
                                                                                                                                                                                        <?php echo "No more results  Found"?></td></tr>
                                                                                                                                                                                        <?php
																							}
																							?>
																							</table><br><br><br>
